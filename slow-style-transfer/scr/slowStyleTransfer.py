# Neural Style Transfer using Gatys' Method
...
def run_style_transfer(args):
	...
	style_img = image_loader(args.style_image, device)
...
def main():
	...
	stylize_arg_parser.add_argument("--style-image", type=str, required=True,
	                                help="path to style-image")
	stylize_arg_parser.add_argument("--content-image", type=str, required=True,
	                                help="path to style-image")
	stylize_arg_parser.add_argument("--output-image", type=str, required=True,
	                             	help="path for saving the output image")
	stylize_arg_parser.add_argument("--num_steps", type=str, default=300,
	                             	help="path for saving the output image")
